# coding:utf-8
"""
Django settings for flyDog project.
...
SECRET_KEY = '&2+b+_-x41h33)fnyl=i@zkyruqp=il@d*f%8b2+f_#z)%$4$x'
...
WSGI_APPLICATION = 'flyDog.wsgi.application'
